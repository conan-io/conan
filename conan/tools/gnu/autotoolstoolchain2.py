...
class AutotoolsToolchain2:
    def __init__(self, conanfile, namespace=None, prefix="/"):
        ...
        self.make_args = {}
        # Initializing configure arguments
        self.configure_args.update(self._default_configure_shared_flags())
        self.configure_args.update(self._default_configure_install_flags())
        # Apple stuff
    ...
    def generate(self, env=None, scope="build"):
        ...
        if self.cross_build:
            self.configure_args.update({
                "--host": self.cross_build["host"]["triplet"],
