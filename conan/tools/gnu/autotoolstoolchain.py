...
class AutotoolsToolchain:
    def __init__(self, conanfile, namespace=None):
        ...
        if cross_building(self._conanfile):
            ...
            compiler = self._conanfile.settings.get_safe("compiler.base") or self._conanfile.settings.get_safe("compiler")
            self._host = _get_gnu_triplet(os_host, arch_host, compiler)
            self._build = _get_gnu_triplet(os_build, arch_build, compiler)
