...
def copy(conanfile, pattern, src, dst, keep_path=True, excludes=None,
    ...
    """ It will copy the files matching the pattern from the src folder to the dst, including the
        ...
        param keep_path: False if you want the relative paths to be maintained from src to
        dst folders, or just drop. False is useful if you want to collect e.g. many .libs
        among many dirs into a single lib dir
