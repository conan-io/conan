...
class CMake(object):
    ...
    def configure(self, variables=None, build_script_folder=None, cli_args=None, redirect_stdout=None):
        """
        ...
        :param redirect_stdout: Redirect stdout to this file
        """
        ...
        with chdir(self, build_folder):
            self._run(command, redirect_stdout=redirect_stdout)

    def _build(self, build_type=None, target=None, cli_args=None, build_tool_args=None, env="", redirect_stdout=None):
        ...
        self._run(command, redirect_stdout=redirect_stdout, env=env)

    def build(self, build_type=None, target=None, cli_args=None, build_tool_args=None, redirect_stdout=None):
        """
        ...
        self._build(build_type, target, cli_args, build_tool_args, redirect_stdout=redirect_stdout)

    def install(self, build_type=None, component=None, cli_args=None, redirect_stdout=None):
        """
    ...
    def test(self, build_type=None, target=None, cli_args=None, build_tool_args=None, env="", redirect_stdout=None):
        """
        ...
        self._build(build_type=build_type, target=target, cli_args=cli_args,
                    build_tool_args=build_tool_args, env=env, redirect_stdout=redirect_stdout)
    ...
    def _run(self, command, redirect_stdout=None, **kwargs):
