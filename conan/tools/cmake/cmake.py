...
class CMake:
    ...
    def configure(self, variables=None, build_script_folder=None, cli_args=None,
                  stdout=None, stderr=None, subfolder=None, env=""):
        """
        ...
        :param env: the environment files to activate, by default conanbuild
        """
        ...
        # Source the build environment to make build tools (like cmake) available in PATH
        env = ["conanbuild"] if env == "" else env
