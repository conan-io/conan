...
class CMake(object):
    ...
    def configure(self, variables=None, build_script_folder=None, cli_args=None,
        ...
        :param cli_args: List of arguments ``[arg1, arg2, ...]`` that will be passed as extra CLI
                         arguments to pass to cmake invocation
    ...
    def test(self, build_type=None, target=None, cli_args=None, build_tool_args=None, env="",
        ...
        :param cli_args: Same as above ``build()``, a list of arguments ``[arg1, arg2, ...]``
                         to be passed as extra arguments for the underlying
                         build system
    ...
    def ctest(self, cli_args=None, env="", stdout=None, stderr=None):
        ...
        :param cli_args: List of arguments ``[arg1, arg2, ...]`` to be passed
                         as extra ctest command line arguments
