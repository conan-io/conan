...
class CMakeConfigDeps:
    ...
    def _get_find_mode(self, dep, comp_name=None):
        tmp = self.get_property("cmake_find_mode", dep, comp_name=comp_name)
        if tmp is None:
            return "config"
        return tmp.lower()
