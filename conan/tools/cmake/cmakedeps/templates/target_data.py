...
class ConfigDataTemplate(CMakeDepsFileTemplate):
    ...
    def template(self):
        ...
        ret = textwrap.dedent("""\
              ...
              set({{ pkg_name }}_LIBRARY_DIRS{{ config_suffix }} {{ global_cpp.lib_paths }})
              set({{ pkg_name }}_LIB_DIRS{{ config_suffix }} {{ global_cpp.lib_paths }})
              set({{ pkg_name }}_LIBRARIES{{ config_suffix }} {{ global_cpp.libs }})
              ...
              set({{ pkg_name }}_{{ comp_name }}_LIBRARY{{ config_suffix }} {{ cpp.libs }})
