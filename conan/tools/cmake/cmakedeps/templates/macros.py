...
class MacrosTemplate(CMakeDepsFileTemplate):
    ...
    def template(self):
       ...
       function(conan_package_library_targets libraries package_libdir deps out_libraries out_libraries_target config_suffix package_name nosoname)
           set(_out_libraries "")
           ...
           foreach(_LIBRARY_NAME ${libraries})
               ...
               if(CONAN_FOUND_LIBRARY)
                   ...
                   if(NOT TARGET ${_LIB_NAME})
                       ...
                       if(${nosoname})
                          set_target_properties(${_LIB_NAME} PROPERTIES IMPORTED_LOCATION ${CONAN_FOUND_LIBRARY} IMPORTED_NO_SONAME ON)
                       else()
