...
class MacrosTemplate(CMakeDepsFileTemplate):
    ...
    def template(self):
       ...
       function(conan_package_library_targets libraries package_libdir package_bindir library_type is_host_windows deps out_libraries out_libraries_target config_suffix package_name soname_mode)
           set(_out_libraries "")
                       ...
                       if(is_host_windows AND library_type STREQUAL "SHARED")
                         ...
                         if(NOT CONAN_SHARED_FOUND_LIBRARY)
                           ...
                           set_target_properties(${_LIB_NAME} PROPERTIES IMPORTED_LOCATION ${CONAN_FOUND_LIBRARY})
                            ...
                            set_target_properties(${_LIB_NAME} PROPERTIES IMPORTED_LOCATION ${CONAN_SHARED_FOUND_LIBRARY} IMPORTED_NO_SONAME ${soname_mode})
                         ...
                         set_target_properties(${_LIB_NAME} PROPERTIES IMPORTED_LOCATION ${CONAN_FOUND_LIBRARY} IMPORTED_NO_SONAME ${soname_mode})
                       endif()
