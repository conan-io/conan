...
class Qbs(object):
    ...
    This class providers helper methods that wraps calls to the Qbs tool.
    '''
    ...
    def add_configuration(self, name, values):
        ...
        :param values: the dict contaning Qbs properties and their values for this configuration.
        '''
