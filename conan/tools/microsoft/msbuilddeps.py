...
class MSBuildDeps(object):
    ...
    def __init__(self, conanfile):
        ...
        self.configuration_condition_key = "Configuration"
        #: Defines the configuration key used to name the property sheets generated by conan.
        self.configuration_filename_key = "Configuration"
        ...
        self.platform_condition_key = "Platform"
        #: Defines the platform key used to name the property sheets generated by conan.
        self.platform_filename_key = "Platform"
    ...
    def _config_filename(self):
        props = [(self.configuration_filename_key, self.configuration),
                 (self.platform_filename_key, self.platform)]
        name = "".join("_%s" % v for _, v in props)
        return name.lower()

    def _condition(self):
        props = [(self.configuration_condition_key, self.configuration),
                 (self.platform_condition_key, self.platform)]
