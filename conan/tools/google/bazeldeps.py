...
class _BazelPathsGenerator:
    ...
    module_template_rules_cc = textwrap.dedent("""\
        ...
        """)
    module_include_template = textwrap.dedent("""\
        # Generated by BazelDeps. Include in your MODULE.bazel file with:
        # include("//conan:conan_deps.MODULE.bazel")
    ...
    def items(cls, dependencies_context):
        ...
        module_include_template = Template(cls.module_include_template, trim_blocks=True,
