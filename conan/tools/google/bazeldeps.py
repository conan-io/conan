...
class BazelDeps:
    ...
    def generate(self):
        ...
        save(
            f"{self._conanfile.generators_folder}/conan_deps_repo_rules.bzl",
            textwrap.dedent("""\
            ...
            # Each conan package is loaded into a bazel repository rule, with having the name of the package.
            # The whole method is based on symlinks to not copy the whole package into the Bazel workspace,
            # which is expensive.
