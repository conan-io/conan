...
class _Component:
    ...
    def serialize(self):
        return {
            ...
            "cflags": self._cflags if not callable(self._cflags) else None,
            "cxxflags": self._cxxflags if not callable(self._cxxflags) else None,
            "sharedlinkflags": (self._sharedlinkflags if not callable(self._sharedlinkflags)
                                else None),
            "exelinkflags": self._exelinkflags if not callable(self._exelinkflags) else None,
