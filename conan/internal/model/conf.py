...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmaketoolchain:add_rpath_link": "Add -Wl,-rpath-link flags pointing to all lib directories for host dependencies",
    ...
    "tools.meson.mesontoolchain:add_rpath_link": "Add -Wl,-rpath-link flags pointing to all lib directories for host dependencies",
