...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmakedeps:new": "Use the new CMakeConfigDeps generator instead of CMakeDeps",
    "tools.cmake:ctest_args": "To inject list of arguments to CMake.ctest() runner",
    "tools.cmake:configure_args": "To inject list of arguments to CMake.configure() via CMakePresets",
