...
BUILT_IN_CONFS = {
    ...
    "tools.google.bazel:rules_cc": "When True, load C++ rules from rules_cc via a conan_cc.bzl wrapper in the main repository. Required for Bazel 9+. Also add bazel_dep(name = 'rules_cc', ...) to MODULE.bazel",
