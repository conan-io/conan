...
BUILT_IN_CONFS = {
    ...
    "core.graph:compatibility_mode": "Set this to 'optimized' to enable the improved compatibility behaviour when querying multiple compatible binaries in remotes",
    # Tools
