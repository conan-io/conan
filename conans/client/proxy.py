...
class ConanProxy(object):
    ...
    def list_authenticated_users(self, all_remotes):
        """
        Display a list of authenticated users against required remote(s)
        :param all_remotes: True/False display a list against all available remotes or current remote
        """
        current_remote, _ = self._get_remote()
