...
# default_channel = stable            # environment CONAN_CHANNEL
# default_username = cbot             # environment CONAN_USERNAME
...
class ConanClientConfigParser(ConfigParser, object):
    ...
    def env_vars(self):
        ret = {"CONAN_LOG_RUN_TO_OUTPUT": self._env_c("log.run_to_output", "CONAN_LOG_RUN_TO_OUTPUT", "True"),
               ...
               "CONAN_VERBOSE_TRACEBACK": self._env_c("general.verbose_traceback",
