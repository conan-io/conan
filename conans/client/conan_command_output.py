...
class CommandOutputer(object):
    ...
    def _grab_info_data(self, deps_graph, grab_paths):
        ...
        library_requires = deps_graph.non_build_requires()
        ...
        for (ref, package_id), list_nodes in compact_nodes.items():
            ...
            requires = [d for d in depends if d in library_requires]
            build_requires = [d for d in depends if d not in library_requires]
