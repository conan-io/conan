...
macro(conan_set_std)
  if (CMAKE_VERSION VERSION_LESS "3.1")
    ...
    if(CONAN_STD_C_FLAG)
      message(STATUS "Conan setting C_FLAGS flags: ${CONAN_STD_C_FLAG}")
      set(CMAKE_C_FLAGS "-std=${CONAN_STD_C_FLAG} ${CMAKE_C_FLAGS}")
    endif()
  else()
    ...
    if(CONAN_CMAKE_C_STANDARD)
      message(STATUS "Conan setting C STANDARD: ${CONAN_CMAKE_C_STANDARD} WITH EXTENSIONS ${CONAN_CMAKE_C_EXTENSIONS}")
      set(CMAKE_C_STANDARD ${CONAN_CMAKE_C_STANDARD})
      set(CMAKE_C_EXTENSIONS ${CONAN_CMAKE_C_EXTENSIONS})
    endif()
  endif ()
endmacro()
...
macro(conan_basic_setup)
    set(options TARGETS NO_OUTPUT_DIRS SKIP_RPATH SKIP_STD)
