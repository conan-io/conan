...
function(check_compiler_version)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES MSVC)
        ...
        if(
            ...
            (CONAN_COMPILER_VERSION STREQUAL "16" AND NOT(VERSION_MAJOR STREQUAL "19" AND VERSION_MINOR STRGREATER "9" AND VERSION_MINOR STRLESS "20" )) OR
            # 1910-1919 = VS 15.0 (v141 toolset)
            (CONAN_COMPILER_VERSION STREQUAL "15" AND NOT(VERSION_MAJOR STREQUAL "19" AND VERSION_MINOR STRGREATER "9" AND VERSION_MINOR STRLESS "20" )) OR
            # 1900      = VS 14.0 (v140 toolset)
            (CONAN_COMPILER_VERSION STREQUAL "14" AND NOT(VERSION_MAJOR STREQUAL "19" AND VERSION_MINOR STRLESS "10")) OR
