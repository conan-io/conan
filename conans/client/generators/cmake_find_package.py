...
class CMakeFindPackageGenerator(GeneratorComponentsMixin, Generator):
    ...
    find_template = textwrap.dedent("""
        ...
        conan_message(VERBOSE "Conan: Using autogenerated Find{filename}.cmake")
        # Global approach
    ...
    find_components_tpl = Template(textwrap.dedent("""\
        ...
        conan_message(VERBOSE "Conan: Using autogenerated Find{{ pkg_filename }}.cmake")
        ...
        if(NOT {{ pkg_public_dep_filename }}_FOUND)
            ...
            conan_message(DEBUG "Conan: Dependency {{ pkg_public_dep_filename }} already found")
        endif()
