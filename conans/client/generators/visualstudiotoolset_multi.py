...
class VisualStudioToolsetMultiGenerator(Generator):
...
"""
    ...
    def content(self):
        ...
        condition = " '$(Configuration)' == '%s' And '$(Platform)' == '%s' And '$(PlatformToolset)' == '%s' "\
                    % (configuration, platform, toolset)

        name_multi = 'conanbuildinfo_multipleToolsets.props'
        name_current = ('conanbuildinfo_%s_%s_%s.props' % (configuration, platform, toolset)).lower()
