...
def get_generator(conanfile):
    ...
    os_build, _, _, _ = get_cross_building_settings(conanfile.settings,
                                                    getattr(conanfile, 'settings_build', None))
...
class CMakeDefinitionsBuilder(object):
    ...
    def _cmake_cross_build_defines(self):
        ...
        os_build, _, _, _ = get_cross_building_settings(
            self._conanfile.settings, getattr(self._conanfile, 'settings_build', None))
