...
def get_default_compatibility():
    return textwrap.dedent("""\
        # This file was generated by Conan. Keep this comment line if you want Conan to update this file automatically.
...
def migrate_compatibility_files(cache, updater):
    ...
    updater(compatibility_file, get_default_compatibility())
    updater(app_compat_file, get_default_app_compat())
    updater(cppstd_compat_file, get_default_cppstd_compat())
