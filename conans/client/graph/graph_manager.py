...
class GraphManager(object):
    ...
    def load_graph(self, reference, create_reference, graph_info, build_mode, check_updates, update,
                   remotes, recorder, apply_build_requires=True, lockfile_id=None):
    ...
    def _load_root_node(self, reference, create_reference, graph_info, lockfile_id):
        ...
        if isinstance(reference, ConanFileReference):
            return self._load_root_direct_reference(reference, graph_lock, profile, lockfile_id)
    ...
    def _load_root_direct_reference(self, reference, graph_lock, profile, lockfile_id):
