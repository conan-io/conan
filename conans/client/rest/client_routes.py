...
class ClientCommonRouter(object):
    ...
    def ping(self):
        return self.base_url + self._routes.ping
    ...
    def search(self, pattern, ignorecase):
        ...
        return self.base_url + "%s%s" % (self._routes.common_search, query)

    def search_packages(self, ref, query=None):
        """URL search packages for a recipe"""
        route = self._routes.common_search_packages_revision \
            if ref.revision else self._routes.common_search_packages
    ...
    def oauth_authenticate(self):
        return self.base_url + self._routes.oauth_authenticate

    def common_authenticate(self):
        return self.base_url + self._routes.common_authenticate

    def common_check_credentials(self):
        return self.base_url + self._routes.common_check_credentials
...
class ClientV1Router(ClientCommonRouter):
    ...
    def __init__(self, base_url):
        super(ClientV1Router, self).__init__(routes=RestRoutes(matrix_params=False))
    ...
    def remove_recipe_files(self, ref):
        ...
        return self.base_url + _format_ref(self._routes.v1_remove_recipe_files, ref.copy_clear_rev())

    def remove_packages(self, ref):
        """Remove files from a package"""
        return self.base_url + _format_ref(self._routes.v1_remove_packages, ref.copy_clear_rev())
    ...
    def recipe_manifest(self, ref):
        """get recipe manifest url"""
        return self.base_url + _format_ref(self._routes.v1_recipe_digest, ref.copy_clear_rev())

    def package_manifest(self, pref):
        """get manifest url"""
        return self.base_url + _format_pref(self._routes.v1_package_digest, pref.copy_clear_revs())

    def recipe_download_urls(self, ref):
        """ urls to download the recipe"""
        return self.base_url + _format_ref(self._routes.v1_recipe_download_urls,
                                           ref.copy_clear_rev())

    def package_download_urls(self, pref):
        """ urls to download the package"""
        pref = pref.copy_with_revs(None, None)
        return self.base_url + _format_pref(self._routes.v1_package_download_urls, pref)

    def recipe_upload_urls(self, ref):
        """ urls to upload the recipe"""
        return self.base_url + _format_ref(self._routes.v1_recipe_upload_urls, ref.copy_clear_rev())

    def package_upload_urls(self, pref):
        """ urls to upload the package"""
        pref = pref.copy_with_revs(None, None)
        return self.base_url + _format_pref(self._routes.v1_package_upload_urls, pref)

    def _for_recipe(self, ref):
        return _format_ref(self._routes.recipe, ref.copy_clear_rev())

    def _for_package(self, pref):
        pref = pref.copy_with_revs(None, None)
        return _format_pref(self._routes.package, pref)
...
class ClientV2Router(ClientCommonRouter):
    ...
    def __init__(self, base_url, artifacts_properties):
        super(ClientV2Router, self).__init__(routes=RestRoutes(matrix_params=True))
    ...
    def recipe_revisions(self, ref):
        ...
        return self.base_url + _format_ref(self._routes.recipe_revisions, ref)
    ...
    def package_revisions(self, pref):
        ...
        return self.base_url + _format_pref(self._routes.package_revisions, pref)
    ...
    def package_latest(self, pref):
        ...
        return self.base_url + _format_pref(self._routes.package_revision_latest, pref)

    def recipe_latest(self, ref):
        """Get the latest of a recipe"""
        assert ref.revision is None, "for_recipe_latest shouldn't receive RREV"
        return self.base_url + _format_ref(self._routes.recipe_latest, ref)
    ...
    def _for_package_file(self, pref, path, matrix_params):
        ...
        return ClientV2Router._format_pref_path(self._routes.package_revision_file, pref, path,
    ...
    def _for_package_files(self, pref):
        ...
        return _format_pref(self._routes.package_revision_files, pref)
    ...
    def _for_recipe_file(self, ref, path, matrix_params):
        ...
        return ClientV2Router._format_ref_path(self._routes.recipe_revision_file, ref, path,
                                               matrix_params=matrix_params)

    def _for_recipe_files(self, ref):
        """url for getting the recipe list"""
        assert ref.revision is not None, "for_recipe_files needs RREV"
        return _format_ref(self._routes.recipe_revision_files, ref)

    def _for_recipe(self, ref):
        """url for a recipe with or without revisions (without rev,
        only for delete the root recipe, or v1)"""
        return _format_ref(self._routes.recipe_revision, ref)

    def _for_packages(self, ref):
        """url for a recipe with or without revisions"""
        return _format_ref(self._routes.packages_revision, ref)

    def _for_package(self, pref):
        """url for the package with or without revisions"""
        return _format_pref(self._routes.package_revision, pref)
