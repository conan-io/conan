...
class PathLengthLimitTest(unittest.TestCase):
    ...
    def upload_test(self):
        ...
        for command in ("install", "download"):
            ...
            package_folder = client2.cache.package_layout(pref.ref).package(pref, short_paths=None)
    ...
    def basic_test(self):
        ...
        package_folder = client.cache.package_layout(pref.ref).package(pref, short_paths=None)
