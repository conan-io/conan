...
class LayoutTest(unittest.TestCase):
    ...
    def test_editable_crash(self):
        ...
        client2 = TestClient(base_folder=client.cache.cache_folder)
    ...
    def test_missing_wrong_layouts(self):
        ...
        client2 = TestClient(client.cache.cache_folder)
    ...
    def test_repo_layouts(self):
        ...
        layout_cache = textwrap.dedent("""
            ...
            include_{}
            """)
        layout_folder = os.path.join(client.cache.cache_folder, LAYOUTS_FOLDER)
