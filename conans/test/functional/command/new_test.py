    ...
    def template_test(self):
        ...
        template1 = textwrap.dedent("""
            class {{package_name}}Conan(ConanFile):
                ...
                version = "{{version}}"
        """)
        save(os.path.join(client.cache.cache_folder, "templates/mytemplate.py"), template1)
    ...
    def template_test_package_test(self):
        ...
        template2 = textwrap.dedent("""
            class {{package_name}}Conan(ConanFile):
                version = "fixed"
        """)
        save(os.path.join(client.cache.cache_folder, "templates", "subfolder",
                          "mytemplate.py"), template2)
