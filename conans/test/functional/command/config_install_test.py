...
class ConfigInstallTest(unittest.TestCase):
    ...
    def _check(self, params):
        ...
        self.assertEqual("#Custom pylint",
                         load(os.path.join(self.client.base_folder, "pylintrc")))
        self.assertEqual("",
                         load(os.path.join(self.client.base_folder, "python",
                                           "__init__.py")))
        self.assertEqual("#hook dummy",
                         load(os.path.join(self.client.base_folder, "hooks", "dummy")))
        self.assertEqual("#hook foo",
                         load(os.path.join(self.client.base_folder, "hooks", "foo.py")))
        self.assertEqual("#hook custom",
                         load(os.path.join(self.client.base_folder, "hooks", "custom",
                                           "custom.py")))
        self.assertFalse(os.path.exists(os.path.join(self.client.base_folder, "hooks",
                                                     ".git")))
        self.assertFalse(os.path.exists(os.path.join(self.client.base_folder, ".git")))
...
"""
    ...
    def install_source_target_folders_test(self):
        ...
        content = load(os.path.join(self.client.base_folder, "newsubf/file.txt"))
        self.assertEqual(content, "hello")
        content = load(os.path.join(self.client.base_folder, "newsubf/subf/file2.txt"))
    ...
    def install_multiple_configs_test(self):
        ...
        content = load(os.path.join(self.client.base_folder, "file.txt"))
        file2 = os.path.join(self.client.base_folder, "file2.txt")
        self.assertEqual(content, "hello")
    ...
    def test_git_checkout_is_possible(self):
        ...
        with self.client.chdir(folder):
            ...
            self.client.run_command('git checkout master')
        other_path = os.path.join(self.client.base_folder, "hooks", "other", "other.py")
