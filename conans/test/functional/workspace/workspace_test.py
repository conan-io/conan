...
class WorkspaceTest(unittest.TestCase):
    ...
    def parse_test(self):
        ...
        Workspace(path, None, output)
        self.assertIn("WARN: Workspace editable 'HelloB/0.1@lasote/stable' "
                      "unrecognized fields: {'random': 'something'}", output)
        ...
        output = TestBufferConanOutput()
        Workspace(path, None, output)
        self.assertIn("WARN: Workspace unrecognized fields: {'random': 'something'}", output)
