...
class WorkspaceTest(unittest.TestCase):
    ...
    def test_graph_failure(self):
        ...
        client.run("export fmt fmt/version@user/channel")
        client.run("export libA libA/version@user/channel")
        client.run("export libB libB/version@user/channel")
        client.run("export libC libC/version@user/channel")
