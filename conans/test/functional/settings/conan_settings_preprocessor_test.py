...
class HelloConan(ConanFile):
    ...
    def test_runtime_auto(self):
        ...
        self.client.run("install --reference=hello0/0.1@lasote/channel --build missing")
        self.assertIn("Runtime: MD", self.client.out)
        self.client.run("install --reference=hello0/0.1@lasote/channel --build missing -s build_type=Debug")
    ...
    def test_runtime_not_present_ok(self):
        ...
        self.client.run('install --reference=hello0/0.1@lasote/channel --build missing -s '
