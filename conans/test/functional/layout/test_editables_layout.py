...
def test_cpp_info_components_editable():
    ...
    assert "**FOO libdirs:['lib']**" in out  # The components do have default dirs
    assert "**FOO builddirs:[]**" in out
    ...
    assert "**VAR libdirs:['lib']**" in out  # The components do have default dirs
    assert "**VAR builddirs:[]**" in out
