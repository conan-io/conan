...
class PrinterTest(unittest.TestCase):
    ...
    def print_profile_test(self):
        self.client.run("profile new empty_profile")
        self.client.run("profile show empty_profile")
        self.assertIn("Configuration for profile empty_profile:", self.client.out)
        self.assertIn("[settings]\n[options]\n[build_requires]\n[env]", self.client.out)

        self.client.run("profile show '%s'" % os.path.join(self.client.current_folder,
                                                           "test_profile"))
        self.assertIn(test_profile, self.client.out)
