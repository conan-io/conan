...
class TransitiveGraphTest(GraphManagerTest):
    ...
    def test_transitive_two_levels(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libb], build_deps=[], dependents=[],
                         closure=[libb, liba])
    ...
    def test_diamond(self):
        ...
        # No Revision??? Because of consumer?
        self._check_node(app, "app/0.1@_/_", deps=[libb, libc], build_deps=[], dependents=[],
    ...
    def test_consecutive_diamonds(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libe, libf], build_deps=[], dependents=[],
    ...
    def test_parallel_diamond(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libb, libc, libd], build_deps=[],
    ...
    def test_multiple_transitive(self):
        ...
        self._check_node(liba, "liba/0.1@_/_", deps=[libd, libc, libb], build_deps=[],
                         dependents=[],
    ...
    def test_basic_build_require(self, build_require):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[], build_deps=[tool], dependents=[],
                         closure=[tool])
    ...
    def test_transitive_build_require_recipe(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[lib], build_deps=[], dependents=[],
                         closure=[lib])
    ...
    def test_transitive_build_require_recipe_profile(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[lib], build_deps=[mingw_app], dependents=[],
    ...
    def test_consecutive_diamonds_build_requires(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libe], build_deps=[libf], dependents=[],
    ...
    def test_parallel_diamond_build_requires(self):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libb, libc], build_deps=[libd],
    ...
    def test_build_require_link_order(self):
        ...
        self._check_node(cheetah, "cheetah/0.1@_/_", deps=[gazelle], build_deps=[grass2],
    ...
    def test_dont_skip_private(self, private_first):
        ...
        self._check_node(app, "app/0.1@_/_", deps=[libc], build_deps=[], dependents=[],
