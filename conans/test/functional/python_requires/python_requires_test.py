...
"""
    ...
    def test_transitive_python_requires(self):
        ...
        conanfile = textwrap.dedent("""
            ...
            class BaseClass(ConanFile):
                ...
                def build(self):
                    v = self.python_requires["shared-function"].module.myvar  # v will be 123
                    f = self.python_requires["shared-function"].module.myfunct()  # f will be 234
