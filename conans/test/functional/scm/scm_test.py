...
'''
        ...
        self.client.save({"conanfile.py": conanfile})
        self.client.run("create . user/channel")
        folder = self.client.client_cache.source(self.ref)
    ...
    def test_auto_filesystem_remote_git(self):
        ...
        os.remove(self.client.client_cache.scm_folder(self.ref))
    ...
    def test_auto_git(self):
        ...
        self.client.run("create . user/channel")
        sources_dir = self.client.client_cache.scm_folder(self.ref)
...
"""
        ...
        exported_conanfile = self.client.client_cache.conanfile(ref)
...
""" % client.current_folder.replace("\\", "/")
        ...
        exported_conanfile = client.client_cache.conanfile(ref)
        content = load(exported_conanfile)
        self.assertIn(commit, content)
