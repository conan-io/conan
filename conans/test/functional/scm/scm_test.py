...
'''
        ...
        self.client.save({"conanfile.py": conanfile})
        self.client.run("create . user/channel")
        folder = self.client.cache.get_latest_ref_layout(self.ref).source()
    ...
    def test_auto_subfolder(self):
        ...
        folder = self.client.cache.get_latest_ref_layout(ref).source()
    ...
    def test_auto_conanfile_no_root(self):
        ...
        ref = ConanFileReference.loads("lib/0.1@user/channel")
        source_folder = self.client.cache.get_latest_ref_layout(ref).source()
    ...
    def test_excluded_repo_files(self):
        ...
        bf = self.client.cache.get_latest_pkg_layout(pref).build()
...
'''.format(url=project_url, rev=rev)
    ...
    def test_non_commited_changes_export(self):
        ...
        for command in ("export .", "create ."):
            ...
            folder = self.client.cache.get_latest_ref_layout(ref).export()
