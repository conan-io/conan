...
class GitSCMTest(unittest.TestCase):
    ...
    def _commit_contents(self):
        self.client.run_command("git init .", cwd=self.client.current_folder)
        self.client.run_command('git config user.email "you@example.com"', cwd=self.client.current_folder)
        self.client.run_command('git config user.name "Your Name"', cwd=self.client.current_folder)
        self.client.run_command("git add .", cwd=self.client.current_folder)
        self.client.run_command('git commit -m  "commiting"', cwd=self.client.current_folder)
...
'''
    ...
    def test_auto_filesystem_remote_git(self):
        ...
        self.client.run_command("git init .", cwd=repo)
        self.client.run_command('git config user.email "you@example.com"', cwd=repo)
        self.client.run_command('git config user.name "Your Name"', cwd=repo)
        self.client.run_command("git add .", cwd=repo)
        self.client.run_command('git commit -m  "commiting"', cwd=repo)
    ...
    def test_auto_git(self):
        ...
        self.client.run_command('git remote add origin https://myrepo.com.git', cwd=curdir)
    ...
    def test_deleted_source_folder(self):
        ...
        self.client.save({"conanfile.py": conanfile, "myfile.txt": "My file is copied"})
        create_local_git_repo(folder=self.client.current_folder)
        self.client.run_command('git remote add origin "%s"' % path.replace("\\", "/"), cwd=curdir)
        self.client.run("export . user/channel")
...
"""
    ...
    def test_install_checked_out(self):
        ...
        self.client.run_command(cmd, cwd=curdir)
...
'''
        path, _ = create_local_git_repo({"myfile": "contents", "conanfile.py": conanfile},
                                        branch="my_release")
        self.client.current_folder = path
        self.client.run_command('git remote add origin https://myrepo.com.git', cwd=path)
...
""" % client.current_folder.replace("\\", "/")
        ...
        client.run_command('git remote add origin "%s"' % path.replace("\\", "/"), cwd=path)
...
class SVNSCMTest(SVNLocalRepoTestCase):
    ...
    def _commit_contents(self):
        self.client.run_command("svn add *", cwd=self.client.current_folder)
        self.client.run_command('svn commit -m  "commiting"', cwd=self.client.current_folder)
