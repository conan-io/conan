...
class GraphLockModifyConanfileTestCase(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual("added", lock_file_json["graph_lock"]["nodes"]["1"]["modified"])
