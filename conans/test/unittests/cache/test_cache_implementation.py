...
@pytest.fixture
def cache_implementation() -> Cache:
...
class TestFolders:
    def test_reference_without_rrev(self, cache_implementation: Cache):
    ...
    def test_reference_with_rrev(self, cache_implementation: Cache):
    ...
    def test_reference_existing(self, cache_implementation: Cache):
        ref = ConanFileReference.loads('name/version@user/channel')
    ...
    def test_package_without_prev(self, cache_implementation: Cache):
    ...
    def test_package_with_prev(self, cache_implementation: Cache):
        # By default the cache will assign deterministics folders
    ...
    def test_package_existing(self, cache_implementation: Cache):
        pref = PackageReference.loads('name/version@user/channel#1111111111:123456789')
        cache_implementation.get_or_create_reference_layout(pref.ref)
...
def test_create_workflow(cache_implementation: Cache):
...
def test_concurrent_package(cache_implementation: Cache):
...
def test_concurrent_read_write_recipe(cache_implementation: Cache):
...
def test_concurrent_write_recipe_package(cache_implementation: Cache):
