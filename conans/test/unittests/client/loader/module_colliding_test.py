...
class ModuleCollidingTest(unittest.TestCase):
    """ Scenario: there are two conanfiles.py that are accompanied by files with the same name.
        As conanfiles are loaded dynamically (and doesn't know about each other), each of them
