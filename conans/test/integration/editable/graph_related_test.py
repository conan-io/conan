...
class EmptyCacheTestMixin(object):
    ...
    def setUp(self):
        ...
        self.assertFalse(os.path.exists(self.t.cache.get_latest_pkg_layout(self.ref).base_folder))
...
class ExistingCacheTestMixin(object):
    ...
    def setUp(self):
        ...
        self.assertTrue(os.path.exists(self.t.cache.get_latest_pkg_layout(self.ref).base_folder))
        self.assertListEqual(sorted(os.listdir(self.t.cache.get_latest_pkg_layout(self.ref).base_folder)),
...
class RelatedToGraphBehavior(object):
    ...
    def test_install_requirements(self, update):
        ...
        self.assertFalse(os.path.exists(self.t.cache.get_latest_pkg_layout(ref_parent).base_folder))
        ...
        self.assertIn("    parent/version@lasote/channel from 'default' - Downloaded",
                      self.t.out)
        self.assertTrue(os.path.exists(self.t.cache.get_latest_pkg_layout(ref_parent).base_folder()))
