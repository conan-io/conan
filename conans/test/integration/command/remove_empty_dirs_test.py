...
class RemoveEmptyDirsTest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        rrev = client.cache.get_latest_rrev(RecipeReference.loads("Hello/0.1@lasote/stable"))
    ...
    def test_shared_folder(self):
        ...
        rrev2 = client.cache.get_latest_rrev(RecipeReference.loads("Hello/0.1@lasote2/stable"))
