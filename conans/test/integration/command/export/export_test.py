...
"""
    ...
    def test_export_the_same_code(self):
        ...
        reg_path2 = client2.cache.get_latest_ref_layout(self.ref).export()
        digest2 = FileTreeManifest.load(client2.cache.get_latest_ref_layout(self.ref).export())
    ...
    def test_export_a_new_version(self):
        ...
        reg_path3 = client2.cache.get_latest_ref_layout(self.ref).export()
        digest3 = FileTreeManifest.load(client2.cache.get_latest_ref_layout(self.ref).export())
    ...
    def _create_packages_and_builds(self):
        reg_builds = self.client.cache.get_latest_pkg_layout(self.ref).build()
        reg_packs = self.client.cache.get_latest_pkg_layout(self.ref).package()
...
def test_export_casing():
    ...
    export_src_folder = client.cache.get_latest_ref_layout(ref).export_sources()
    ...
    exports_folder = client.cache.get_latest_ref_layout(ref).export()
