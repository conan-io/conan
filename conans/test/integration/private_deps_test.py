...
class PrivateDepsTest(unittest.TestCase):
    ...
    def modern_cmake_test(self):
        ...
        self.assertRegexpMatches(conanbuildinfo_cmake, "\\${CONAN_GF_TARGET} PROPERTY "
                                 "INTERFACE_LINK_LIBRARIES .+\\${CONAN_GLEW_TARGET}\)")
        self.assertRegexpMatches(conanbuildinfo_cmake, "\\${CONAN_IMGUITEST_TARGET} PROPERTY "
                                 "INTERFACE_LINK_LIBRARIES .+\\${CONAN_GLM_TARGET} \\${CONAN_GF_TARGET}\)")
