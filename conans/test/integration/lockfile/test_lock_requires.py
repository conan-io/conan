...
def test_conanfile_txt_strict(requires):
    ...
    # --lockfile-nostrict can relax the error and proceed even if not locked in range
    client.run("install consumer/conanfile.txt --lockfile=conan.lock --lockfile-nostrict")
