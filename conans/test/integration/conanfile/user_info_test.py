    ...
    def test_user_info_propagation(self):
        ...
        reuse = textwrap.dedent("""
            ...
            class MyConanfile(ConanFile):
                ...
                def build(self):
                    assert self.dependencies.transitive_host_requires["LIB_A"].user_info.VAR1=="2"
                    assert self.dependencies.transitive_host_requires["LIB_B"].user_info.VAR1=="2"
                    assert self.dependencies.transitive_host_requires["LIB_B"].user_info.VAR2=="3"
                    assert self.dependencies.transitive_host_requires["LIB_C"].user_info.VAR1=="2"
                    assert self.dependencies.transitive_host_requires["LIB_C"].user_info.VAR1=="2"
                """)
