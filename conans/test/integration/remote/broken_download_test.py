...
class BrokenDownloadTest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        self.assertTrue(os.path.exists(client.cache.get_latest_ref_layout(ref).export()))
        ...
        self.assertFalse(os.path.exists(client.cache.get_latest_ref_layout(ref).export()))
