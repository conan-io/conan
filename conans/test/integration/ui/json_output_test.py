...
class JsonOutputTest(unittest.TestCase):
    ...
    def test_simple_fields(self):
        ...
        self.client.run("install c/1.0@private_user/channel --json=myfile.json --build missing ")
        my_json = json.loads(self.client.load("myfile.json"))
        ...
        self.client.run("remove '*' -f")
        self.client.run("install c/1.0@private_user/channel --json=myfile.json")
        my_json = json.loads(self.client.load("myfile.json"))
    ...
    def test_errors(self):
        ...
        self.client.run("remove '*' -f")
        self.client.run("install c/1.0@private_user/channel --json=myfile.json", assert_error=True)
        my_json = json.loads(self.client.load("myfile.json"))
