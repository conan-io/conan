...
class PyRequiresExtendTest(unittest.TestCase):
    ...
    def test_with_alias(self):
        client = TestClient()
        self._define_base(client)
        client.run("new alias --name=base --version=latest --target=1.1@user/testing")
    ...
    def test_python_requires_with_alias(self, use_alias, use_alias_of_alias):
        ...
        client.run("new alias --name=python_requires0 --version=latest --target=1.0@user/test")
        client.run("export . --user=user --channel=test")
        client.run("new alias --name=python_requires0 --version=latest2 --target=latest@user/test")
        client.run("export . --user=user --channel=test")
        ...
        client.run("new alias --name=python_requires1 --version=latest --target=1.0@user/test")
        client.run("export . --user=user --channel=test")
        client.run("new alias --name=python_requires1 --version=latest2 --target=latest@user/test")
        client.run("export . --user=user --channel=test")
        ...
        client.run("new alias --name=python_requires11 --version=latest --target=1.0@user/test")
        client.run("export . --user=user --channel=test")
        client.run("new alias --name=python_requires11 --version=latest2 --target=latest@user/test")
        client.run("export . --user=user --channel=test")
        ...
        client.run("new alias --name=python_requires22 --version=latest --target=1.0@user/test")
        client.run("export . --user=user --channel=test")
        client.run("new alias --name=python_requires22 --version=latest2 --target=latest@user/test")
        client.run("export . --user=user --channel=test")
        ...
        client.run("new alias --name=python_requires2 --version=latest --target=1.0@user/test")
        client.run("export . --user=user --channel=test")
        client.run("new alias --name=python_requires2 --version=latest2 --target=latest@user/test")
        client.run("export . --user=user --channel=test")
