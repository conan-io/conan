...
"""
        ...
        client.save({CONANFILE: conanfile,
                     "hello.py": hello_file,
                     "__init__.py": ""})
        client.run("export . me/testing")
        client.save({CONANFILE: conanfile_consumer}, clean_first=True)
        client.run("export . me/testing")
        self.assertNotIn("WARN: Linter. Line 10: Unable to import 'hello'", client.out)
