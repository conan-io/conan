...
class RemoteTest(unittest.TestCase):
    ...
    def basic_refs_test(self):
        self.client.run("remote padd Hello/0.1@user/testing remote0")
        self.client.run("remote plist")
        self.assertIn("Hello/0.1@user/testing: remote0", self.client.user_io.out)

        self.client.run("remote padd Hello1/0.1@user/testing remote1")
        self.client.run("remote plist")
        self.assertIn("Hello/0.1@user/testing: remote0", self.client.user_io.out)
        self.assertIn("Hello1/0.1@user/testing: remote1", self.client.user_io.out)

        self.client.run("remote premove Hello1/0.1@user/testing")
        self.client.run("remote plist")
        self.assertIn("Hello/0.1@user/testing: remote0", self.client.user_io.out)
        ...
        self.client.run("remote pupdate Hello1/0.1@user/testing remote2")
        self.client.run("remote plist")
        self.assertIn("Hello/0.1@user/testing: remote0", self.client.user_io.out)
