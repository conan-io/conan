...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmaketoolchain.presets:user_presets_path": "Define a path (relative to source_folder) where the CMakeToolchain will write the CMakeUserPresets.json file",
