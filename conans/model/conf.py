...
BUILT_IN_CONFS = {
    ...
    "tools.build:archiver": "Define the archiver executable name or full path",
    "tools.build:c_compiler": "Define the C compiler executable name or full path",
    "tools.build:cxx_compiler": "Define the C++ compiler executable name or full path",
    "tools.build:linker": "Define the linker executable name or full path",
