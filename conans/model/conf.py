...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmaketoolchain:set_compilers": "Defines a dict-like Python object to set CMAKE_<LANG>_COMPILER variable, e.g., {'C': '/usr/bin/gcc', 'CXX': 'g++'}",
    "tools.cmake.cmaketoolchain:set_compiler_launchers": "Defines a dict-like Python object to set CMAKE_<LANG>_COMPILER_LAUNCHER variable, e.g., {'C': 'ccache'}",
