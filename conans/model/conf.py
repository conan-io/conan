...
BUILT_IN_CONFS = {
    ...
    "tools.cmake.cmaketoolchain:experimental_find_package_traces": "Enable the experimental find_package traces in CMakeToolchain for non Conan provided packages",
