...
BUILT_IN_CONFS = {
    ...
    "tools.build:cxx_compiler": "Defines the path to the CXX compiler, e.g., '/usr/bin/clang++'",
    "tools.build:c_compiler": "Defines the path to the CXX compiler, e.g., '/usr/bin/clang'",
    "tools.build:objc_compiler": "Defines the path to the Objective-C compiler, e.g., '/usr/bin/clang'",
    "tools.build:objcxx_compiler": "Defines the path to the Objective-CXX compiler, e.g., '/usr/bin/clang++'",
    "tools.build:rc_compiler": "Defines the path to the Windows Resource Compiler, e.g., 'C:\\Program Files (x86)\\Microsoft Visual Studio 11.0\\VC\\bin' ",
