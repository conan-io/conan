...
BUILT_IN_CONFS = {
    ...
    "tools.build.cross_building:native": "(boolean) Decides, when it is a cross-building, whether to use an isolated build context in the toolchains (MesonToolchain for now).",
    ...
    "tools.meson.mesontoolchain:extra_machine_files": "List of additional native/cross file references to be appended to the Meson setup command, e.g., ['--native-file myfile.ini']",
