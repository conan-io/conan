...
def test_issue():
    ...
    tc.run("new header_lib -d name=pkg3 -d version=1.0 -d requires=pkg4/1.0 -o=pkg3")
    tc.run("new cmake_lib -d name=pkg2 -d version=1.0 -d requires=pkg3/1.0 -o=pkg2")
    tc.run("new cmake_lib -d name=pkg1 -d version=1.0 -d requires=pkg2/1.0 -d requires=pkg3/1.0 -o=pkg1")
