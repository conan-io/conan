...
def test_build_requires_ranges():
    ...
    assert "REQUIRE cmake/0.5: cmake/0.5" in client.out
    assert "CMAKEVER: 0.5!!" in client.out
    assert "REQUIRE cmake/1.0: cmake/1.0" in client.out
    assert "CMAKEVER: 1.0!!" in client.out
    assert "REQUIRE cmake/0.5: cmake/0.5" in client.out
    assert "CMAKEVER: 0.5!!" in client.out
