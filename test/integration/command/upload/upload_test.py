...
class UploadTest(unittest.TestCase):
    ...
    def test_corrupt_upload(self):
        ...
        self.assertIn("ERROR: hello0/1.2.1@frodo/stable#3afd661184b94bdac7fb2057e7bd9baa"
                      ":da39a3ee5e6b4b0d3255bfef95601890afd80709"
                      "#e70e86439dec07a0d5d3414648b0b16", client.out)
        self.assertIn("ERROR:     'include/hello.h' (manifest: d41d8cd98f00b204e9800998ecf8427e, file: None)", client.out)
        self.assertIn("ERROR:     'added.txt' (manifest: None, file: d41d8cd98f00b204e9800998ecf8427e)", client.out)
