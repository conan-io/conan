...
def test_install_transitive_cache(client):
    ...
    assert "Package step for hello0/0.1@lasote/stable:" in client.out
    assert "Package step for hello1/0.1@lasote/stable:" in client.out
    assert "Package step for hello2/0.1@lasote/stable:" in client.out
